...
public class OrderConvertors {
	...
	public static OrderDetails convertTradeResponse(TradeEntity tradeEntity) {
		
		OrderDetails orderDetails = new OrderDetails();
		orderDetails.setCode("200");
		orderDetails.setStatus("Succefully traded.");
		orderDetails.setMessage("Created trade with trade Id"+tradeEntity.getTrade_id());
		return orderDetails;
	...
	public static OrderDetails convertOrderResponse() {
		...
		OrderDetails orderDetails = new OrderDetails();
		orderDetails.setCode("200");
		orderDetails.setStatus("Succefully created order.");
		orderDetails.setMessage("Created order waiting for perfect trade");
		return orderDetails;
